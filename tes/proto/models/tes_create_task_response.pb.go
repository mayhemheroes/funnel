...
// 	protoc        v3.17.2
// source: models/tes_create_task_response.proto
...
func (x *TesCreateTaskResponse) Reset() {
	*x = TesCreateTaskResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_models_tes_create_task_response_proto_msgTypes[0]
...
func (*TesCreateTaskResponse) Descriptor() ([]byte, []int) {
	return file_models_tes_create_task_response_proto_rawDescGZIP(), []int{0}
}
...
var File_models_tes_create_task_response_proto protoreflect.FileDescriptor

var file_models_tes_create_task_response_proto_rawDesc = []byte{
	0x0a, 0x25, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2f, 0x74, 0x65, 0x73, 0x5f, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x22,
	0x28, 0x0a, 0x15, 0x54, 0x65, 0x73, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x61, 0x73, 0x6b,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0f, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x9b,
	0x1a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74,
	...
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_models_tes_create_task_response_proto_rawDescOnce sync.Once
	file_models_tes_create_task_response_proto_rawDescData = file_models_tes_create_task_response_proto_rawDesc
)

func file_models_tes_create_task_response_proto_rawDescGZIP() []byte {
	file_models_tes_create_task_response_proto_rawDescOnce.Do(func() {
		file_models_tes_create_task_response_proto_rawDescData = protoimpl.X.CompressGZIP(file_models_tes_create_task_response_proto_rawDescData)
	})
	return file_models_tes_create_task_response_proto_rawDescData
}

var file_models_tes_create_task_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_models_tes_create_task_response_proto_goTypes = []interface{}{
	(*TesCreateTaskResponse)(nil), // 0: models.TesCreateTaskResponse
}
var file_models_tes_create_task_response_proto_depIdxs = []int32{
...
func init() { file_models_tes_create_task_response_proto_init() }
func file_models_tes_create_task_response_proto_init() {
	if File_models_tes_create_task_response_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_models_tes_create_task_response_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_models_tes_create_task_response_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_models_tes_create_task_response_proto_goTypes,
		DependencyIndexes: file_models_tes_create_task_response_proto_depIdxs,
		MessageInfos:      file_models_tes_create_task_response_proto_msgTypes,
	}.Build()
	File_models_tes_create_task_response_proto = out.File
	file_models_tes_create_task_response_proto_rawDesc = nil
	file_models_tes_create_task_response_proto_goTypes = nil
	file_models_tes_create_task_response_proto_depIdxs = nil
}
