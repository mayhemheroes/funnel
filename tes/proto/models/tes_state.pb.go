...
type TesState struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *TesState) Reset() {
	*x = TesState{}
	if protoimpl.UnsafeEnabled {
		mi := &file_models_tes_state_proto_msgTypes[0]
...
func (*TesState) ProtoMessage() {}

func (x *TesState) ProtoReflect() protoreflect.Message {
	mi := &file_models_tes_state_proto_msgTypes[0]
...
// Deprecated: Use TesState.ProtoReflect.Descriptor instead.
func (*TesState) Descriptor() ([]byte, []int) {
	return file_models_tes_state_proto_rawDescGZIP(), []int{0}
}

var File_models_tes_state_proto protoreflect.FileDescriptor

var file_models_tes_state_proto_rawDesc = []byte{
	0x0a, 0x16, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2f, 0x74, 0x65, 0x73, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73,
	0x22, 0x0a, 0x0a, 0x08, 0x54, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x32, 0x5a, 0x30,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x68, 0x73, 0x75, 0x2d,
	0x63, 0x6f, 0x6d, 0x70, 0x2d, 0x62, 0x69, 0x6f, 0x2f, 0x66, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x2f,
	0x74, 0x65, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_models_tes_state_proto_rawDescOnce sync.Once
	file_models_tes_state_proto_rawDescData = file_models_tes_state_proto_rawDesc
)

func file_models_tes_state_proto_rawDescGZIP() []byte {
	file_models_tes_state_proto_rawDescOnce.Do(func() {
		file_models_tes_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_models_tes_state_proto_rawDescData)
	})
	return file_models_tes_state_proto_rawDescData
}

var file_models_tes_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_models_tes_state_proto_goTypes = []interface{}{
	(*TesState)(nil), // 0: models.TesState
}
var file_models_tes_state_proto_depIdxs = []int32{
...
func init() { file_models_tes_state_proto_init() }
func file_models_tes_state_proto_init() {
	if File_models_tes_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_models_tes_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TesState); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_models_tes_state_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_models_tes_state_proto_goTypes,
		DependencyIndexes: file_models_tes_state_proto_depIdxs,
		MessageInfos:      file_models_tes_state_proto_msgTypes,
	}.Build()
	File_models_tes_state_proto = out.File
	file_models_tes_state_proto_rawDesc = nil
	file_models_tes_state_proto_goTypes = nil
	file_models_tes_state_proto_depIdxs = nil
}
