...
// AssertTesCreateTaskResponseRequired checks if the required fields are not zero-ed
func AssertTesCreateTaskResponseRequired(obj TesCreateTaskResponse) error {
...
// AssertRecurseTesCreateTaskResponseRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of TesCreateTaskResponse (e.g. [][]TesCreateTaskResponse), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseTesCreateTaskResponseRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aTesCreateTaskResponse, ok := obj.(TesCreateTaskResponse)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertTesCreateTaskResponseRequired(aTesCreateTaskResponse)
	})
}
