...
type TesServiceInfoAllOf struct {
	...
	Type TesServiceType `json:"type,omitempty"`
}

// AssertTesServiceInfoAllOfRequired checks if the required fields are not zero-ed
func AssertTesServiceInfoAllOfRequired(obj TesServiceInfoAllOf) error {
...
// AssertRecurseTesServiceInfoAllOfRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of TesServiceInfoAllOf (e.g. [][]TesServiceInfoAllOf), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseTesServiceInfoAllOfRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aTesServiceInfoAllOf, ok := obj.(TesServiceInfoAllOf)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertTesServiceInfoAllOfRequired(aTesServiceInfoAllOf)
	})
}
